...
<head>
		...
		<!-- Css -->
        <link href="cssprofile/bootstrap.css" rel="stylesheet" type="text/css" media="all"/>
		<link href="cssprofile/base.css" rel="stylesheet" type="text/css" media="all"/>
		<link href="cssprofile/main.css" rel="stylesheet" type="text/css" media="all"/>
        <link href="cssprofile/owl-carousel/owl.carousel.css" rel="stylesheet"  media="all">
		<link href="cssprofile/owl-carousel/owl.theme.css" rel="stylesheet"  media="all">
		<link href="cssprofile/magnific-popup.css" type="text/css" rel="stylesheet" media="all" />
		<link href="cssprofile/fontello.css" rel="stylesheet" type="text/css"  media="all">
    </head>
...
<!--Javascript-->	
<script src="jsprofile/jquery-1.11.3.min.js" type="text/javascript"></script>
<script src="jsprofile/owl.carousel.js" type="text/javascript"></script>
<script src="jsprofile/jquery.magnific-popup.js" type="text/javascript"></script>
<script src="jsprofile/jquery.easytabs.min.js" type="text/javascript"></script>
<script src="jsprofile/instafeed.min.js" type="text/javascript"></script>
<script src="jsprofile/placeholders.min.js" type="text/javascript"></script>
<script src="jsprofile/script.js" type="text/javascript"></script>
