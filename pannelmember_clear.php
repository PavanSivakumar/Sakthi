...
<script type="text/javascript">
    ...
    {
            <?php  
            $full113=mysqli_query($con,"select * from clearence where $name='0'"); 
            $ec=1;
            ?>
    }
    </script>
...
================================================== -->
            ...
            <li><a href="pannel_clear.php">Clearence</a></li>
<li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome <span style="color: red;"><?php echo $_SESSION['name']; ?> </span><span class="caret"></span></a>
                                <div class="dropdown-menu">
                                    <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="pannelmember_clear.php" method="post">
...
<!--==================== Pannel Marks=============-->
 <section class="company-description">        
      ...
      <form action="pannel_clear.php" method="post">
        <table class="table ">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        {
          while($row112 = mysqli_fetch_assoc($full113)) { ?>
        <tr>
          <th scope="row"><?=$y?></th>
          <td><?=$row112['id'];?></td>
          <td><?=$row112['name'];?></td>
          <?php $_SESSION['infinit']=1 ?>
 <td><center><input type="checkbox" value="<?=$row112['id'];?>" name="check12[]"/></center></td>  
            <?php  
              if($_SESSION['mark1']=="")
              {
                  $_SESSION['mark1']=$row112['id'];
                  $_SESSION['admin']=$_SESSION['name'];
              }
        else
        {
              $_SESSION['mark1']=$_SESSION['mark1'].",".$row112['id'];  
        }
            ?>
           <?php $y+=1; ?>
            </tr>
