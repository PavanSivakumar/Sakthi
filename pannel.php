            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a  style="margin-top: -5px;text-decoration:none;">
...
<!--==================== Pannel Marks=============-->
 <section class="company-description">
    <div class="column col3">
      ...
      <form action="stu_mark_updation.php" method="post">
        <table class="table ">
      <thead>
        <tr>
          <th scope="col">ID</th>
          ...
          <th scope="col"><center>Marks Scored</center></th>
        </tr>
      </thead>
      <tbody>
         <?php
         $_SESSION['mark1']="";
          ...
          $d1=$_POST['date'];
           $admin=$_SESSION['name'];
              $ver=mysqli_query($con,"select * from staff where active='2' and permission='$d1' and admin='$admin' ;");
              $rowver=mysqli_fetch_assoc($ver);
              if($rowver>0)
              {
           $full=mysqli_query($con,"select * from reg where active='1' and fixed='$d1' and email_ver='1'and working!='1' ");
        ...
        <tr>
          ...
          <td><?=$row['Email']?></td>
           ...
           <td><center><input style="padding:8px;" type="number" name="mark[]" min="1" max="100"  required="" /></center></td>
          <?php  
              if($_SESSION['mark1']=="")
              {
                  $_SESSION['mark1']=$row['id'];
              }
        else
        {
              $_SESSION['mark1']=$_SESSION['mark1'].",".$row['id'];  
        }
            ?>
           <?php $y1+=1; ?>
            </tr>
